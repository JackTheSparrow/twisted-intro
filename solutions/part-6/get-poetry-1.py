...
class PoetryProtocol(Protocol):
    ...
    def __init__(self):
        ...
        self.force_to_finish = reactor.callLater(self.time_to_complete, self.stop_poetry)

    def stop_poetry(self):
        self.factory.errback(TimeOverError('Time to complete task is over.'))

    def dataReceived(self, data):
        self.poem += data

    def connectionLost(self, reason):
        if not self.force_to_finish:
